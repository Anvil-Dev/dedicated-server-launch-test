...
The `1.21.8-neoforge` branch is a compatibility wrapper around the `universal` branch. It runs the universal action with Minecraft `1.21.8`, NeoForge, and loader version `21.8.52`.
