...
This exact-version branch is a compatibility wrapper around the [`universal`](https://github.com/Anvil-Dev/dedicated-server-launch-test/tree/universal) branch. It runs the universal action with Minecraft `1.16.5`, Forge, and Forge loader version `36.2.42`.
...
- name: Test dedicated server launch
  uses: Anvil-Dev/dedicated-server-launch-test@1.16.5-forge
  with:
    mods: |
      path/to/mod.jar
