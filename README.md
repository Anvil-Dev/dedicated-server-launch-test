...
The `26.2-forge` branch is a universal compatibility wrapper around the `universal` branch. It runs the universal action with Minecraft `26.2`, Forge, and loader version `65.1.1`.
...
- name: Test dedicated server launch
  uses: Anvil-Dev/dedicated-server-launch-test@26.2-forge
  with:
    mods: |
      path/to/mod.jar
