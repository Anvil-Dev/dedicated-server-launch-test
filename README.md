# Dedicated Server Launch Test — 1.19.2 Forge

This exact-version branch is a compatibility wrapper around the [`universal`](https://github.com/Anvil-Dev/dedicated-server-launch-test/tree/universal) branch. It delegates the launch test with Minecraft `1.19.2`, Forge, and Forge loader version `43.5.0` fixed for this branch.
...
steps:
  - name: Test dedicated server launch
    uses: Anvil-Dev/dedicated-server-launch-test@1.19.2-forge
    with:
      mods: |
        path/to/mod.jar
