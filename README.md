...
This exact-version branch is a compatibility wrapper around the `universal` branch. It runs the universal dedicated server launch test with Minecraft `1.20.1`, the `forge` mod loader, and Forge loader version `47.4.13`.
