...
The `26.1-forge` branch is a universal compatibility wrapper around the `universal` branch. It runs the universal action with Minecraft `26.1`, Forge, and loader version `62.0.9`.
...
- name: Test dedicated server launch
  uses: Anvil-Dev/dedicated-server-launch-test@26.1-forge
  with:
    mods: |
      path/to/mod.jar
