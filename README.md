...
This exact-version branch is a compatibility wrapper around the `universal` branch. It runs dedicated server launch tests with Minecraft `1.15.2`, Forge, and Forge loader version `31.2.60`.
...
- name: Test dedicated server launch
  uses: Anvil-Dev/dedicated-server-launch-test@1.15.2-forge
  with:
    mods: |
      path/to/mod.jar
