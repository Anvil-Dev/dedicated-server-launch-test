...
The `1.16.5-fabric` branch is a compatibility wrapper around the `universal` branch. It always runs the universal action with Minecraft `1.16.5`, Fabric, and Fabric Loader `0.18.4`.
...
- name: Test dedicated server launch
  uses: Anvil-Dev/dedicated-server-launch-test@1.16.5-fabric
  with:
    mods: |
      path/to/mod.jar
    quiet-setup: "true"
